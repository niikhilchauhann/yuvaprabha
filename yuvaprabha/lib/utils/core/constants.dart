...
final Color secondary = Color(0xFFB194C1);

final Color blue = Color(0xff0156F0);
...
final Color onBackgroundDark = Color(0xFFE0E0E0);
final Color onSurfaceDark = Color(0xFFFAFAFA);
